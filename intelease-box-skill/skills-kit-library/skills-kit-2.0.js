 ...
 */
function SkillsWriter() {
    switch (typeof arguments[0]) {
        case 'string': SkillsWriter.$str.apply(this, arguments); break;
        case 'object': SkillsWriter.$obj.apply(this, arguments); break;
        default: console.log('Could not create SkillsWriter! argument type: ' + (typeof arguments[0]));
    }
}
 ...
 * async SkillsWriter.saveDataCards ( listofDataCardJSONs, optionalCallback): null
 */
SkillsWriter.$obj = function(fileContext) {
 ...
 * async SkillsWriter.saveDataCards ( listofDataCardJSONs, optionalCallback): null
 */
SkillsWriter.$str = function(requestId, skillId, fileId, fileWriteToken) {
    this.requestId = requestId;
    this.skillId = skillId;
    this.fileId = fileId;
    this.fileWriteClient = sdk.getBasicClient(fileWriteToken);
}
